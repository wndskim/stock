...
def 관심주_보기(티커, 종목, 상승파동비율, 위치정보):
    ...
    with col1:
        ...
        현재가=위치정보.loc['현재가'].values[0]

        기준일=위치정보.loc['날짜'].values[0]
        ...
        st.text(현재가값+기준일값+기간최고가값+기간최저가값+최고가52값+최저가52값+'\n'+위치1값+위치2값)
    with col2:
        ...
        가격='         종가: '+str(종가)+'\n'
        내재가치='  내재가치: '+str(숙향가치)+'\n'
        파동001값='    1%값: '+str(파동001)+'\n'
        파동007값='    7%값: '+str(파동007)+'\n'
        파동014값='   14%값: '+str(파동014)+'\n'
        파동021값='   21%값: '+str(파동021)+'\n'
        파동025값='   25%값: '+str(파동025)+'\n'
        파동382값='38.20%값: '+str(파동382)+'\n'
        파동050값='   50%값: '+str(파동050)+'\n'
        파동618값='61.80%값: '+str(파동618)+'\n'
        파동832값='83.20%값: '+str(파동832)+'\n'
        파동100값='  100%값: '+str(파동100)+'\n'
        파동1382값='1.382%값: '+str(파동1382)+'\n'
        파동1618값='1.618%값: '+str(파동1618)+'\n'
        파동200값='  200%값: '+str(파동200)+'\n'
        
        st.text(가격+내재가치+'\n'+파동001값+파동007값+파동014값+파동021값+파동025값+파동382값+파동050값+'\n'+파동618값+파동832값+파동100값+'\n'+파동1382값+파동1618값+파동200값)
