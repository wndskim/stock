...
def 거래량폭증():
    ...
    st.markdown('''
        ...
        ###### :red[2단계 - 재무정보 확인(온라인 화면 사용)]
        ###### :red[2.1 매출성장여부(지난 3년간)]
        ###### :red[2.2 매출이익/당기순이익(지난 3년간)]
        ###### :red[2.3 유동비율/당좌비율/부채비율(지난 3년간)]
        ###### :red[2.4 EPS/PER/PGR/ROE확인]
        ###### :blue[3단계 - 상대강도(선도주인지 여부)]
        ###### :blue[3.1 코스피 지수와 비교한 주가 상승률(업종, 전체)]
